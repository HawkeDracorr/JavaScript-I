...
const internMitzi = {id:1, name:'Mitzi', email:'mmelloy0@psu.edu', gender:'F'};
...
const internKeven = {id:3, name:'Keven', email:'kmummery2@wikimedia.org', gender:'M'};

const internGannie = {id:4, name:'Gannie', email:'gmartinson3@illinois.edu', gender:'M'};
